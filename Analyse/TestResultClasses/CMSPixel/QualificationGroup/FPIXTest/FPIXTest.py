...
class TestResult(GeneralTestResult):
    def CustomInit(self):
        self.Name = 'CMSPixel_QualificationGroup_FPIXTest_TestResult'
        self.NameSingle = 'FPIXTest'
        ...
        if self.verbose:
            print 'Analysing FPIXTest with the following Attributes:'
    ...
    def CustomWriteToDatabase(self, ParentID):
        ...
        Row = {
            ...
            'FPIXTestSubfolder': os.path.relpath(self.FinalResultsStoragePath,
                                                 self.TestResultEnvironmentObject.FinalModuleResultsPath),
            # needed for PixelDB
            'AbsModuleFPIXTestStoragePath': self.TestResultEnvironmentObject.FinalModuleResultsPath,
            'AbsFPIXTestSubfolder': self.FinalResultsStoragePath,
