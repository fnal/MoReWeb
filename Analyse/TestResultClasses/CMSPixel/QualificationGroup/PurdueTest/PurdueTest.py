...
class TestResult(GeneralTestResult):
    def CustomInit(self):
        self.Name = 'CMSPixel_QualificationGroup_PurdueTest_TestResult'
        self.NameSingle = 'PurdueTest'
        ...
        if self.verbose:
            print 'Analysing PurdueTest  with the following Attributes:'
    ...
    def OpenFileHandle(self):
        ...
        fileHandlePath = self.RawTestSessionDataPath + '/commander_Purduetest.root'
    ...
    def CustomWriteToDatabase(self, ParentID):
        ...
        Row = {
            ...
            'PurduetestSubfolder': os.path.relpath(self.FinalResultsStoragePath,
                                                 self.TestResultEnvironmentObject.FinalModuleResultsPath),
            # needed for PixelDB
            'AbsModulePurduetestStoragePath': self.TestResultEnvironmentObject.FinalModuleResultsPath,
            'AbsPurduetestSubfolder': self.FinalResultsStoragePath,
