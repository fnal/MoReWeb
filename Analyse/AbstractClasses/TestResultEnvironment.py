...
class TestResultEnvironment:
    ...
    GradingParameters = {
        ...
        'XRayHighRateEfficiency_NInterpolationRates': 4,
        'XRayHighRateEfficiency_InterpolationRate1': 20,
        'XRayHighRateEfficiency_InterpolationRate2': 50,
        'XRayHighRateEfficiency_InterpolationRate3': 80,
        'XRayHighRateEfficiency_InterpolationRate4': 120,
        ...
        'XRayHighRateEfficiency_max_allowed_loweff_A_Rate3':98,
        'XRayHighRateEfficiency_max_allowed_loweff_A_Rate4':98,
        'XRayHighRateEfficiency_max_allowed_loweff_B_Rate3':95,
        'XRayHighRateEfficiency_max_allowed_loweff_B_Rate4':95,
